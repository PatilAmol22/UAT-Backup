...
export default class GtmCompetition extends LightningElement {
    ...
    @track labels = {
        Combined_Total_Value : Combined_Total_Value,
...
disableInputs(){
    ...
    handleInputChange(event) {
        ...
        if (name == 'Competitor_Name_1__c') {
            ...
            //Removed HardCoded UPL for Display name logic by Priyanka(SKI)
             ...
             {           
              ...
              //Added by Amol Patil(SKI)(02/06/2023)    
                this.gtmcompetitor[gtmIndex].isinput = false;
                this.gtmcompetitor[gtmIndex].Indicate1 = null;
                this.gtmcompetitor[gtmIndex].uplshare = null;
             }
            // To disappear the value of uplposition and upshare on slect 'None' addedd by Amol(SKI=30/5/23)
            if(value=='none'  || this.gtmcompetitor[gtmIndex].Competitor1Name.toLowerCase()!==this.uplName.toLowerCase()){
                this.gtmcompetitor[gtmIndex].Indicate1 = null;
                /*if(value == 'none'){
                    this.gtmcompetitor[gtmIndex].isinput = false;
                }*/
            ...
            console.log('Isinput Check ###:',this.gtmcompetitor[gtmIndex].isinput );
        }
        ...
        if (name == 'Competitor_Name_2__c') {
            ...
            //Added OR Condition to Check Company is Other than UPl by Amol Patil(31/05/2023)
            if(value=='none' || this.gtmcompetitor[gtmIndex].Competitor2Name.toLowerCase()!==this.uplName.toLowerCase()){
                this.gtmcompetitor[gtmIndex].Indicate2 = null;
                 /*if(value == 'none'){
                    this.gtmcompetitor[gtmIndex].isinput = false;
                }*/
        ...
        if (name == 'Competitor_Name_3__c') {
            ...
            //Added OR Condition to Check Company is Other than UPl by Amol Patil(31/05/2023)
            if(value=='none' || this.gtmcompetitor[gtmIndex].Competitor3Name.toLowerCase()!==this.uplName.toLowerCase()){
                this.gtmcompetitor[gtmIndex].Indicate3 = null;
                 /*if(value == 'none'){
                    this.gtmcompetitor[gtmIndex].isinput = false;
                }*/
        ...
        if (name == 'Indicate_share_wallet_of_competitor_3__c') {
           ...
           //Added OR Condition to Check Company is Other than UPl by Amol Patil(31/05/2023)
            if(value=='none' || this.gtmcompetitor[gtmIndex].Competitor4Name.toLowerCase()!==this.uplName.toLowerCase()){
                this.gtmcompetitor[gtmIndex].Indicate4 = null;
                /*if(value == 'none'){
                    this.gtmcompetitor[gtmIndex].isinput = false;
                }*/
        ...
        if (name == 'Competitor_Name_5__c') {
           ...
           //Added OR Condition to Check Company is Other than UPl by Amol Patil(31/05/2023)
            if(value=='none' || this.gtmcompetitor[gtmIndex].Competitor5Name.toLowerCase()!==this.uplName.toLowerCase()){
                this.gtmcompetitor[gtmIndex].Indicate5 = null;
                /*if(value == 'none'){
                    this.gtmcompetitor[gtmIndex].isinput = false;
                }*/
        ...
        if (name == 'Competitor_Name_6__c') {
            ...
            //Added OR Condition to Check Company is Other than UPl by Amol Patil(31/05/2023)
            if(value=='none' || this.gtmcompetitor[gtmIndex].Competitor6Name.toLowerCase()!==this.uplName.toLowerCase()){
                this.gtmcompetitor[gtmIndex].Indicate6 = null;
                /*if(value == 'none'){
                    this.gtmcompetitor[gtmIndex].isinput = false;
                }*/
            ...
            if( this.gtmcompetitor[gtmIndex].Competitor7Name.toLowerCase()==this.uplName.toLowerCase())
             ...
             //Added OR Condition to Check Company is Other than UPl by Amol Patil(31/05/2023)
            if(value=='none' || this.gtmcompetitor[gtmIndex].Competitor7Name.toLowerCase()!==this.uplName.toLowerCase()){
                this.gtmcompetitor[gtmIndex].Indicate7 = null;
                /*if(value == 'none'){
                    this.gtmcompetitor[gtmIndex].isinput = false;
                }*/
            ...
            if( this.gtmcompetitor[gtmIndex].Competitor8Name.toLowerCase()==this.uplName.toLowerCase())
             {
                this.gtmcompetitor[gtmIndex].uplposition=8; 
                  //Added by Amol Patil(02/06/2023) 
                this.gtmcompetitor[gtmIndex].isinput = false; 
             ...
             //Added OR Condition to Check Company is Other than UPl by Amol Patil(31/05/2023) 
            if(value=='none' || this.gtmcompetitor[gtmIndex].Competitor8Name.toLowerCase()!==this.uplName.toLowerCase()){
                this.gtmcompetitor[gtmIndex].Indicate8 = null;
                /*if(value == 'none'){
                    this.gtmcompetitor[gtmIndex].isinput = false;
                }*/
       ...
       // To disappear the value of uplposition and upshare on select Other Than UPL addedd by Amol(SKI=30/5/23)
        if( (name == 'Competitor_Name_1__c' || name == 'Competitor_Name_2__c' || name == 'Competitor_Name_3__c'
            || name == 'Competitor_Name_4__c' || name == 'Competitor_Name_5__c' || name == 'Competitor_Name_6__c'
            || name == 'Competitor_Name_7__c' || name == 'Competitor_Name_8__c') &&
            this.gtmcompetitor[gtmIndex].Competitor1Name.toLowerCase() !== this.uplName.toLowerCase() &&
            this.gtmcompetitor[gtmIndex].Competitor2Name.toLowerCase() !== this.uplName.toLowerCase() &&
            this.gtmcompetitor[gtmIndex].Competitor3Name.toLowerCase() !== this.uplName.toLowerCase() &&
            this.gtmcompetitor[gtmIndex].Competitor4Name.toLowerCase() !== this.uplName.toLowerCase() &&
            this.gtmcompetitor[gtmIndex].Competitor5Name.toLowerCase() !== this.uplName.toLowerCase() &&
            this.gtmcompetitor[gtmIndex].Competitor6Name.toLowerCase() !== this.uplName.toLowerCase() &&
            this.gtmcompetitor[gtmIndex].Competitor7Name.toLowerCase() !== this.uplName.toLowerCase() &&
            this.gtmcompetitor[gtmIndex].Competitor8Name.toLowerCase() !== this.uplName.toLowerCase()
        ){ 
            if(!this.gtmcompetitor[gtmIndex].isinput || this.gtmcompetitor[gtmIndex].Competitor1Name == 'none'){
                console.log('@@@ Null Value For uplposition & uplshare @@@',value);
                this.gtmcompetitor[gtmIndex].uplposition = null; 
                this.gtmcompetitor[gtmIndex].uplshare = null;
            }
        }
        ...
        if (name == 'UPL_Position__c') {
            ...
            this.gtmcompetitor[gtmIndex].isinput = true;
            console.log('Isinput Check @@@@',this.gtmcompetitor[gtmIndex].isinput)
    ...
    updatePicklistOptions(obj,name) {
        ...
        //Added if Condition to Remove Uplshare on Error by Amol Patil(02/06/2023)
        if(initialPercentage>100 && name){
            if(name=='Indicate_share_wallet_of_competitor_1__c'){if(obj.Competitor1Name.toLowerCase()==this.uplName.toLowerCase()){obj.uplshare=null;} obj.Indicate1 = null; initialPercentage = Number(initialPercentage) - Number(gtmDetail.Indicate_share_wallet_of_competitor_1__c);gtmDetail.Indicate_share_wallet_of_competitor_1__c=null}
            if(name=='Indicate_share_wallet_of_competitor_2__c'){if(obj.Competitor2Name.toLowerCase()==this.uplName.toLowerCase()){obj.uplshare=null;} obj.Indicate2 = null; initialPercentage = Number(initialPercentage) - Number(gtmDetail.Indicate_share_wallet_of_competitor_2__c);gtmDetail.Indicate_share_wallet_of_competitor_2__c=null}
            if(name=='Indicate_share_wallet_of_competitor_3__c'){if(obj.Competitor3Name.toLowerCase()==this.uplName.toLowerCase()){obj.uplshare=null;} obj.Indicate3 = null; initialPercentage = Number(initialPercentage) - Number(gtmDetail.Indicate_share_wallet_of_competitor_3__c);gtmDetail.Indicate_share_wallet_of_competitor_3__c=null}
            if(name=='Indicate_share_wallet_of_competitor_4__c'){if(obj.Competitor4Name.toLowerCase()==this.uplName.toLowerCase()){obj.uplshare=null;} obj.Indicate4 = null; initialPercentage = Number(initialPercentage) - Number(gtmDetail.Indicate_share_wallet_of_competitor_4__c);gtmDetail.Indicate_share_wallet_of_competitor_4__c=null}
            if(name=='Indicate_share_wallet_of_competitor_5__c'){if(obj.Competitor5Name.toLowerCase()==this.uplName.toLowerCase()){obj.uplshare=null;} obj.Indicate5 = null; initialPercentage = Number(initialPercentage) - Number(gtmDetail.Indicate_share_wallet_of_competitor_5__c);gtmDetail.Indicate_share_wallet_of_competitor_5__c=null}
            if(name=='Indicate_share_wallet_of_competitor_6__c'){if(obj.Competitor6Name.toLowerCase()==this.uplName.toLowerCase()){obj.uplshare=null;} obj.Indicate6 = null; initialPercentage = Number(initialPercentage) - Number(gtmDetail.Indicate_share_wallet_of_competitor_6__c);gtmDetail.Indicate_share_wallet_of_competitor_6__c=null}
            if(name=='Indicate_share_wallet_of_competitor_7__c'){if(obj.Competitor7Name.toLowerCase()==this.uplName.toLowerCase()){obj.uplshare=null;} obj.Indicate7 = null; initialPercentage = Number(initialPercentage) - Number(gtmDetail.Indicate_share_wallet_of_competitor_7__c);gtmDetail.Indicate_share_wallet_of_competitor_7__c=null}
            if(name=='Indicate_share_wallet_of_competitor_8__c'){if(obj.Competitor8Name.toLowerCase()==this.uplName.toLowerCase()){obj.uplshare=null;} obj.Indicate8 = null; initialPercentage = Number(initialPercentage) - Number(gtmDetail.Indicate_share_wallet_of_competitor_8__c);gtmDetail.Indicate_share_wallet_of_competitor_8__c=null}
            ...
            this.showToast(this.labels.Combined_Total_Value, this.labels.Combined_total_value_more_than_100_is_not_allowed, 'error', 'dismissable');
        }
