...
export default class DemandGeneration extends NavigationMixin(LightningElement) {
  ...
  //@track profName=''; // add this for RITM0556384 GRZ(Javed Ahmed) 25-05-2023 // Updated for RITM0581449 GRZ(Dheeraj Sharma) 29-06-2023
...
*/
  ...
  userDetails3({ error, data }) {
    if (data) {
     // this.profName=data.fields.Profile.displayValue;// add this for RITM0556384 GRZ(Javed Ahmed) 25-05-2023 // Updated for RITM0581449 GRZ(Dheeraj Sharma) 29-06-2023
  ...
  @wire(getRecord, { recordId: uId, fields: [UserNameFld,Userprofile] })  // Updated for RITM0581449 GRZ(Dheeraj Sharma) 29-06-2023
  ...
  userDetails1({ error, data }) {
   ...
   // var profileName =this.profName; //add this for RITM0556384 GRZ(Javed Ahmed) 25-05-2023  // Updated for RITM0581449 GRZ(Dheeraj Sharma) 29-06-2023
    console.log('budgetUser', bdgtUser );

    if (data) {
      console.log('User data is', data);
      console.log('User name in New ', data.fields.Name.value);
      console.log('data.fields.profile.displayValue', data.fields.Profile.displayValue);
      for (var i = 0; i < bdgtUser.length; i++) {
        if (data.fields.Name.value == bdgtUser[i] || data.fields.Profile.displayValue==bdgtUser[i]) { //add profileName chcek for RITM0556384 GRZ(Javed Ahmed) 25-05-2023 // Updated for RITM0581449 GRZ(Dheeraj Sharma) 29-06-2023
