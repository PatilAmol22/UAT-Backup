...
import getDetails from "@salesforce/apex/grz_SalesOrderReturnFnlController.getDetails";
...
export default class Grz_SalesOrderReturnFnl extends NavigationMixin(LightningElement) {
    approvalPercent;
    finalApprover=null;
    ytdAmt;
    ...
    fhApprover=null;
    connectedCallback() {
        this.getInvLineData(this.recid);
    }
   /* @wire(getDetails, {invoiceId: this.recid})
        getRecord({ error, data }) {
             if (data) {
            this.detailsData = data;
            this.data = data.InvoiceLineItemList;
   ...
   this.showToast=false;
    ...
    handleChange(event){
        ...
        this.orderreasonval = event.target.value;
    }
