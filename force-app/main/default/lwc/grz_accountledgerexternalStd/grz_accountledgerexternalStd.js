...
export default class Grz_accountledgerexternalStd extends LightningElement {
    @api recordId;
    @track labels;
    ...
    generatedDocumentURL(){
        this.pdfURL = "/uplpartnerportalstd/apex/Grz_AccountLedgerExternalPDF?customerCode=" +
        ...
        this.xlsURL = "/uplpartnerportalstd/apex/Grz_AccountLedgerExternalXLS?customerCode=" +
                        this.account[0].SAP_Customer_Code__c +
                        "&companyCode=" +
                        this.account[0].Company_Code__c +
                        "&sapUserId=" +
