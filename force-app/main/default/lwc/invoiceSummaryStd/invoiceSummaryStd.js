...
export default class InvoiceSummary extends LightningElement {
    ...
    @track columns1 = [
        ...
        { label: this.labels.Doc_Amount, fieldName: 'Doc_Amount', type: 'currency', wrapText: true, sortable: 'true', hideDefaultActions: 'true', typeAttributes: { currencyDisplayAs: "code" }, cellAttributes: { alignment: 'left' } },
        {
...
//Change by Grazitti team for Community adoption RITM0429236 12Oct22
    @track JPcolumns = [
        ...
        { label: this.labels.Invoice_Date, fieldName: 'Invoice_Date', type: "date", wrapText: true, sortable: 'true', hideDefaultActions: 'true', typeAttributes: { day: "2-digit", month: "short", year: "numeric" }, cellAttributes: { alignment: 'left' } },
        { label: this.labels.Doc_Amount, fieldName: 'Doc_Amount', type: 'currency', wrapText: true, sortable: 'true', hideDefaultActions: 'true', typeAttributes: { currencyDisplayAs: "code", minimumFractionDigits: 0, maximumFractionDigits: 0 }, cellAttributes: { alignment: 'left' } },
        {
            label: this.labels.View_Invoice,
            type: "button",
            typeAttributes: {
    ...
    @track columns3 = [
        ...
        { label: this.labels.Doc_Amount, fieldName: 'Doc_Amount', type: 'currency', sortable: 'true', hideDefaultActions: 'true', wrapText: true, typeAttributes: { currencyDisplayAs: "code",currencyCode:"PLN"}, cellAttributes: { alignment: 'left' } },
        {
            label: this.labels.View_Invoice,
            type: "button",
            typeAttributes: {
