({
    scriptsBrazil : function(component, event, helper) {		
        var action = component.get("c.getProductCategoryData");
        action.setParams({ 
        ...
        action.setCallback(this, function(data) {
            ...
            if (state === "SUCCESS") {
                ...
                var labelset=[] ;
                var dataset=[] ;
                var chartTitle = 'Valor total do produto: '+ val[0].Total.toLocaleString('pt-BR');
                ...
                if(window.doughnutProduct != undefined) {
                    window.doughnutProduct.destroy();
                }
                window.doughnutProduct = new Chart(document.getElementById("pie-charts-product"), {
                    type: 'doughnut',
                    data: {
                        labels:labelset,
                        datasets: [{
