({
    ...
    onDepotChange: function (component, event, helper) {
        ...
        //Changes for TaskSCTASK0737712. Please confirm.
        if(searchDepot == 'ES51'){
            component.set("v.Selected_Org","2510");//2481;");
        }else if(searchDepot == 'ES52'){
            component.set("v.Selected_Org","2541");
        }else if(searchDepot == 'PT00'){
            component.set("v.Selected_Org","2481");
        }else{
            component.set("v.Selected_Org","2510;2481;2541");
        }
    ...
    onOrgChange : function(component, event, helper){
        ...
        //Changes for TaskSCTASK0737712. Please confirm.
        if(orgValue == '2510' /*|| orgValue == '2481'*/){
            component.set("v.Selected_Depots","ES51");
        }else if(orgValue == '2541'){
            component.set("v.Selected_Depots","ES52");
        }else if(orgValue == '2481'){
            component.set("v.Selected_Depots","PT00");
        }else{
            component.set("v.Selected_Depots","ES51;ES52;PT00");
        }
        //Copy
        var searchKey = component.get("v.selItem"); //event.getParam("term");
        console.log('->On Depot Chnage');
