({
    ...
    hideSpinner: function (component, event, helper) {
        ...
        component.set("v.Spinner", false);  //<-----please On THIS
    },

    // to fetch data on load
    doInit: function (component, event, helper) {
        var userId = $A.get("$SObjectType");
        ...
        helper.fetchDepot(component, helper); //<-----please On THIS
        ...
        if ($A.util.isUndefined(searchKey) || searchKey == '') {
            ...
            helper.searchRequirements(component, searchField, searchKey, page, recordToDisply, searchDepot); //<------ please On THIS
        }
    },
