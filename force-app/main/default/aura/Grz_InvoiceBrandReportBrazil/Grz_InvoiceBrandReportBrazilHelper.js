({
    scriptsBrazil : function(component, event, helper) {		
        var action = component.get("c.getInvoiceBrandData");
        action.setParams({ 
        ...
        action.setCallback(this, function(data) {
            ...
            if (state === "SUCCESS") {
                ...
                var labelset=[] ;
                var dataset=[] ;
                var chartTitle = 'Valor total da fatura: '+ val[0].Total.toLocaleString('pt-BR');
                ...
                if(window.doughnutInvoice != undefined) {
                    window.doughnutInvoice.destroy();
                }
               window.doughnutInvoice = new Chart(document.getElementById("pie-charts-invoice"), {
                    type: 'doughnut',
                    data: {
                        labels:labelset,
                        datasets: [{
