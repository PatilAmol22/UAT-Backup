({
	itemSelected : function(component, event, helper) {
        ...
        if(SelIndex){
            ...
            if(selItem.val){               
                var action = component.get("c.AccountUserInfo");            
                action.setParams({
                    accId : selItem.val,
                });
                ...
                action.setCallback(this, function(response) {
                    ...
                    if (state == "SUCCESS") {
                        console.log('Selected Account User',response.getReturnValue().rwuserList);
                        component.set("v.accountRelatedUser",response.getReturnValue().rwuserList);                        
                    }
                });
    ...
    clearSelection: function(component, event, helper){
        ...
        component.set("v.accountRelatedUser",null);
        component.set("v.server_result",null);
    } 
})