({
    ...
    restrictQuantity: function(component, event, helper){
        ...
        if(qty){
            ...
            if(multipleOf && (qty%multipleOf != 0)){
             ...
             //CR#169 -Chile Margin Block- SKI- kalpesh chande -  05/12/2022 Start Here......Comment
                /*var UpdateRows = component.getEvent("UpdateRows");
                UpdateRows.setParams({
                    rowIndex : component.get("v.rowIndex")
                });
                UpdateRows.fire();*/
            //CR#169 -Chile Margin Block- SKI-kalpesh chande -  05/12/2022 End Here......Comment
                component.getEvent("UpdateRows").setParams({"rowIndex" : component.get("v.rowIndex") }).fire(); //CR#169 -Chile Margin Block- SKI- kalpesh chande -  05/12/2022 
    ...
    // Logic to handle shipping changs 
                    handleShipLocChange : function(component, event,helper){
                        ...
                        helper.updateDraftOrder(component,event,orderItem);
    ...
    tabActionClicked: function(component, event, helper){
        //to change in CLP
        var uomFlag=false; //CR#169 -Chile Margin Block- SKI- kalpesh chande -  05/12/2022
        ...
        //CR#169 -Chile Margin Block- SKI- kalpesh chande -  05/12/2022 - Start Here..Existing code is added into if else condition....
        //var action;
                        ...
                        if(actionId == 'selectproduct'){
                            if(currency =='CLP'){
                                ...
                                if(itemRow.maxPrice!=0){
                                    ...
                                    orderItem.deliveryAddress = "None";
                                ...
                                if(itemRow.unitCost!= undefined)
                                {
                                 ...
                                 console.log('orderItem.unitCost'+orderItem.unitCost);
                                if(itemRow.maxPrice!=0){
                                    orderItem.qty = 0;
                                    //CR#183 -Export Order Management – Chile- SKI- kalpesh chande -14-06-2023 -Start here
                                    orderItem.netSales=0;
                            ...
                            console.log('orderItem.unitValue'+orderItem.unitValue);
                             console.log('orderItem.unitCost'+orderItem.unitValue);
                            helper.updateDraftOrder(component,event,orderItem);
                        }
