({	
        ...
        action.setCallback(this, function(a) {
            ...
            if (state == "SUCCESS") {
               ...
               /* ------End SKI(Vishal P) : #CR152 : PO And Delivery Date : 18-07-2022-------------- */
				...
				console.log('@@@ DistributorData.Inco_Term__c'+ DistributorData.Inco_Term__c);
                console.log('@@@incoTermList'+ incoTermList[0].Id);
                component.set("v.newSalesOrder.Inco_Term__c",incoTermList[0].Id);//CR#183 -Export Order Management – Chile- SKI- kalpesh chande -21-06-2023
               ...
               component.set("v.orderTypeList",returnValue.orderTypeList1);  //CR#183 -Export Order Management – Chile- SKI- kalpesh chande
                console.log("v.orderTypeList>>>"+returnValue.orderTypeList1);
                 component.set("v.newSalesOrder.Order_Type_lk__c",returnValue.orderTypeList1[0].Id);//CR#183 -Export Order Management – Chile- SKI- kalpesh chande
                //CR#169 -Chile Margin Block-SKI- kalpesh chande -SKI-  05/12/2022 - Start Here
          ...
          //CR#169 -Chile Margin Block-SKI- kalpesh chande -SKI  05/12/2022 - End Here
    ...
    fetchSKUData : function(component, event) {
        ...
        var accId =  component.get("v.recordId");
        var orderType=component.get("v.newSalesOrder.Order_Type_lk__c"); //CR#183 -Export Order Management – Chile- SKI- kalpesh chande-28-03-2023
        console.log('orderType@@@'+orderType);
        action.setParams({ 
            "accId": accId,
            "orderTypeSku":orderType //CR#183 -Export Order Management – Chile- SKI- kalpesh chande-28-03-2023
            });  
    ...
    normalUpdateRowCalculations : function(component, event, helper){
        ...
        var grossMargin = 0;
        var totalDisc = 0;
        var totalMaxPrice=0;//CR#169 -Chile Margin Block -SKI- kalpesh chande - 05/12/2022
        var totalD = 0;
        var SumDiscount= 0;
            ...
            if(!orderItemList[idx].productId==false){
                if(flag){
                    ...
                    */
                    ...
                    totalMaxPrice+=parseFloat(orderItemList[idx].maxPrice*orderItemList[idx].qty);//CR#169 -Chile Margin Block -SKI- kalpesh chande - 05/12/2022
                    ...
                    totalDisc = (totalD/totalMaxPrice)*100;//CR#169 -Chile Margin Block -SKI- kalpesh chande - 05/12/2022
    ...
    createDraftOrder:function(component, event) { 
        ...
        component.set("v.totalDisc",totalDisc);
        if(orderItemList.length>0){
            component.set("v.currencyList",orderItemList[0].oiCurrency);
    ...
    createSalesOrder : function(component, event, status) { 
        ...
        console.log('Sayan final PT-->'+component.get("v.newSalesOrder"));
        component.set("v.newSalesOrder.Inco_Term__c",component.get("v.newSalesOrder.Inco_Term__c"));//CR#183 -Export Order Management – Chile- SKI- kalpesh chande -21-06-2023
        ...
        if(isValid && isValidItems ){
            ...
            var toastMsg = '';
            var newSO;//CR#169 -Chile Margin Block -SKI- kalpesh chande - 05/12/2022
   ...
   //CR#169 -Chile Margin Block- kalpesh chande -SKI-  05/12/2022 - End Here
            ...
            newSO = component.get("v.newSalesOrder");//CR#169 -Chile Margin Block -SKI- kalpesh chande - 05/12/2022
            // show spinner to true on click of a button / onload
         //CR#169 -Chile Margin Block-SKI- kalpesh chande -  05/12/2022 - Start Here
            component.set("v.showSpinner", true);
             console.log('order @@@1111 '+JSON.stringify(newSO));
            if(isSimulationOrder==false){
                 action = component.get("c.saveSalesOrder");
            }else{
           //CR#169 -Chile Margin Block-SKI- kalpesh chande -  05/12/2022 - Start Her
                action = component.get("c.checkSimulation");
                
            }
             
                    action.setParams({ 
                        "soObj": newSO,
                        "priceDetailString":JSON.stringify(priceDetailList),//CR#169 -Chile Margin Block-SKI- kalpesh chande -  05/12/2022
                        "salesOrderItemString": JSON.stringify(orderItemList),
                        "isSimulated": false,
                        "salesOrg": salesOrg,
                        "isPaymentTermChanged": isPaymentTermChanged,
                        "isSimulation":isSimulationOrder//CR#169 -Chile Margin Block-SKI- kalpesh chande -  05/12/2022
                    });
            
            if(isSimulationOrder==false){//CR#169 -Chile Margin Block-SKI- kalpesh chande -  05/12/2022
             
            action.setCallback(this, function(a) {
                
                // on call back make it false ,spinner stops after data is retrieved
                component.set("v.showSpinner", false); 
                component.set('v.isModalOpen', false);//CR#169 -Chile Margin Block-SKI- kalpesh chande -  05/12/2022
