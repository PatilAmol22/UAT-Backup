                ...
                if(resp != null){
                    if(resp.soCode != '2410'){
                        ...
                        if(resp.pgCode == '80'){
                            ...
                            evt.setParams({
                                componentDef: "c:SalesOrderItaly_IC",  /* SalesOrderItaly_IC */
                                componentAttributes: {
                                    recordId: recordId
                                }
                            });
                            console.log("Industrial button was created");
                            evt.fire();
                        }else if(resp.pgCode != '80'){
                            var evt = $A.get("e.force:navigateToComponent");
                            evt.setParams({
                                componentDef: "c:SalesOrderItaly",  /* SalesOrderItaly */
                                componentAttributes: {
                                    recordId: recordId
                                }
                            });
