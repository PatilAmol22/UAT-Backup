        ...
        objFileReader.onload = $A.getCallback(function() {
            ...
            action.setCallback(self, function(actionResult) {
                 ...
                 else if(response.includes('NoSuccess'))
				{
					...
					str =  $A.get("$Label.c.All_Record_Creation_Failure")+' Please check email for further details.';
					var toastEvent = $A.get("e.force:showToast");
					toastEvent.setParams({
						"title": "",
						"message": str,
                ...
                else if(response.includes('PartialSuccess'))
				{
					...
					str =  str + ' ' + $A.get("$Label.c.Records_Inserted_Successfully_Secondary_Sales")+' Please check email for further details.';
