({
    doInit: function (component, event, helper) {
        ...
        action.setCallback(this, function(response){
            ...
            if(state === 'SUCCESS'){
                ...
                component.set("v.isStatusDisabled", response.getReturnValue().isStatusDisabled);// add this for RITM0564631 GRZ(Javed Ahmed) 01-06-2023 
                ...
                component.set('v.columns', [
                   ...
                   //Demand Generation- SKI- Amol Patil -  15/02/2023 Start
                    {label: '', type: 'button', initialWidth: 90,typeAttributes:
                    { label:{ fieldName: 'New Demand Generation'},title: $A.get("$Label.c.Demand_Generation"),name: 'NewDemandGeneration',iconName: 'utility:new', disabled: { fieldName: 'isStatusDisabled'}, class: 'btn_next'}}, //set  isStatusDisabled for RITM0564631 GRZ(Javed Ahmed) 01-06-2023 
                   //Demand Generation- SKI- Amol Patil -  15/02/2023 End
               ]);

               
                    component.set("v.totalRecords", component.get("v.data").length);
                    var sObjectList = component.get("v.data");
                    console.log('dat is==>',sObjectList);
                    ...
                    console.log('JAVED'+component.get("v.PaginationList"));
    ...
    Search : function (component, event, helper) {
        ...
        action.setCallback(this, function(response){
            var state = response.getState();
            //For resolving the controller error - Gurubaksh Grewal(Grazitti) (INC0468495)
    ...
    handleRowAction: function (component, event, helper) {
        ...
        switch (action.name) {
            ...
            //Demand Generation- SKI- Amol Patil -  15/02/2023 Start
             case 'NewDemandGeneration':
             helper.newDemandGeneration(component, event, helper, row);
             break;
            //Demand Generation- SKI- Amol Patil -  15/02/2023 End    
            default:
